export default {
    ...
    mainInfo: [
        [
            { title: '我的钱包', subtitle: '办信用卡', image: require('./images/main/icon_mine_wallet.png') },
            { title: '余额', subtitle: '￥95872385', image: require('./images/main/icon_mine_balance.png') },
            { title: '抵用券', subtitle: '63', image: require('./images/main/icon_mine_voucher.png') },
            { title: '会员卡', subtitle: '2', image: require('./images/main/icon_mine_membercard.png') }
        ],
        [
            { title: '好友去哪', image: require('./images/main/icon_mine_friends.png') },
            { title: '我的评价', image: require('./images/main/icon_mine_comment.png') },
            { title: '我的收藏', image: require('./images/main/icon_mine_collection.png') },
            { title: '会员中心', subtitle: 'v15', image: require('./images/main/icon_mine_membercenter.png') },
            { title: '积分商城', subtitle: '好礼已上线', image: require('./images/main/icon_mine_member.png') }
        ],
        [
            { title: '客服中心', image: require('./images/main/icon_mine_customerService.png') },
            { title: '关于美团', subtitle: '我要合作', image: require('./images/main/icon_mine_aboutmeituan.png') }
        ]
    ],
...
return 'http://api.meituan.com/group/v1/recommend/homepage/city/1?__skck=40aaaf01c2fc4801b9c059efcd7aa146&__skcy=mrUZYo7999nH8WgTicdfzaGjaSQ=&__skno=51156DC4-B59A-4108-8812-AD05BF227A47&__skts=1434530933.303717&__skua=bd6b6e8eadfad15571a15c3b9ef9199a&__vhost=api.mobile.meituan.com&ci=1&client=iphone&limit=40&movieBundleVersion=100&msid=48E2B810-805D-4821-9CDD-D5C9E01BC98A2015-06-17-14-50363&offset=0&position=39.983497,116.318042&userId=10086&userid=10086&utm_campaign=AgroupBgroupD100Fab_chunceshishuju__a__a___b1junglehomepagecatesort__b__leftflow___ab_gxhceshi__nostrategy__leftflow___ab_gxhceshi0202__b__a___ab_pindaochangsha__a__leftflow___ab_xinkeceshi__b__leftflow___ab_gxtest__gd__leftflow___ab_gxh_82__nostrategy__leftflow___ab_pindaoshenyang__a__leftflow___i_group_5_2_deallist_poitype__d__d___ab_b_food_57_purepoilist_extinfo__a__a___ab_trip_yidizhoubianyou__b__leftflow___ab_i_group_5_3_poidetaildeallist__a__b___ab_waimaizhanshi__b__b1___a20141120nanning__m1__leftflow___ab_pind'
}